...
export interface ApiBottomBarBottomBar extends Struct.SingleTypeSchema {
  collectionName: 'bottom_bars';
  info: {
    displayName: 'BottomBar';
    pluralName: 'bottom-bars';
    singularName: 'bottom-bar';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiHomeLeistungenHomeLeistungen
  extends Struct.SingleTypeSchema {
  collectionName: 'home_leistungens';
  info: {
    displayName: 'HomeLeistungen';
    pluralName: 'home-leistungens';
    singularName: 'home-leistungen';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::home-leistungen.home-leistungen'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiLeistungenLeistungen extends Struct.CollectionTypeSchema {
